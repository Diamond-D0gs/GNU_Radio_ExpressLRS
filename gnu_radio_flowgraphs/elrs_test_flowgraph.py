...
import elrs_test_flowgraph_epy_block_0 as epy_block_0  # embedded python block
...
class elrs_test_flowgraph(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "ELRS Test Flowgraph", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("ELRS Test Flowgraph")
        ...
        self.settings = Qt.QSettings("GNU Radio", "elrs_test_flowgraph")
        ...
        self.lora_rx_0 = lora_sdr.lora_sdr_lora_rx( bw=125000, cr=1, has_crc=True, impl_head=False, pay_len=255, samp_rate=250000, sf=7, sync_word=[0x12], soft_decoding=True, ldro_mode=2, print_rx=[True,True])
        ...
        self.msg_connect((self.epy_block_0, 'msg_out'), (self.lora_tx_0, 'in'))
        ...
        self.connect((self.lora_tx_0, 0), (self.pfb_arb_resampler_xxx_0, 0))
...
def main(top_block_cls=elrs_test_flowgraph, options=None):
