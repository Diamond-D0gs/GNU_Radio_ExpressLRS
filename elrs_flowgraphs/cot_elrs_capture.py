...
class cot_elrs_capture(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "cot_elrs_capture")
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.qtgui_waterfall_sink_x_0.set_frequency_range(0.915e9, self.samp_rate)




def main(top_block_cls=cot_elrs_capture, options=None):
